    ...
    <section id="contact" className="pt-6 md:pt-8 pb-16 md:pb-24 bg-linear-to-br from-slate-50 via-blue-50/30 to-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto">
          ...
          >
            <div className="bg-white/80 backdrop-blur-lg p-8 md:p-10 rounded-3xl shadow-2xl border border-white/20 relative overflow-hidden h-full">
              ...
              <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                <div className="group">
                  ...
                  <div className="relative">
                    <input
                      ...
                      required
                      className="w-full px-4 py-4 pl-12 bg-gray-50 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-[#0A5FFF]/50 focus:border-[#0A5FFF] focus:bg-white transition-all outline-none group-hover:border-gray-300"
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      required
                      rows={5}
                      className="w-full px-4 py-4 pl-12 bg-gray-50 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-[#0A5FFF]/50 focus:border-[#0A5FFF] focus:bg-white transition-all outline-none resize-none group-hover:border-gray-300"
                ...
                {status.message && (
                  <motion.div
                    ...
                    className={`p-5 rounded-xl flex items-center gap-3 border-2 ${
                      status.type === "success"
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full bg-linear-to-r from-[#0A5FFF] to-[#0849C7] text-white py-5 rounded-xl font-semibold text-lg hover:from-[#084BD6] hover:to-[#0637A0] transition-all duration-200 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed shadow-xl hover:shadow-2xl disabled:hover:scale-100 relative overflow-hidden group"
                >
          ...
          >
            <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 overflow-hidden h-full flex flex-col">
              {/* Map Header */}
              <div className="p-6 bg-linear-to-r from-[#0A5FFF] to-[#0849C7] text-white">
                <h3 className="text-2xl font-bold mb-2">Visit Our Location</h3>
                <p className="text-blue-100">1604 SW 29th Street, Oklahoma City, OK 73119</p>
              </div>
